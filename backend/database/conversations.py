...
class DatabaseManager:
    ...
    def ensure_conversation_exists(self, conversation_id: str, user_id: str, title: Optional[str] = None) -> str:
        """Ensure a conversation exists with the given ID, creating it if necessary."""
        conn = self.get_connection()
        ...
        if result:
            ...
            # Conversation doesn't exist, create it with the specified ID
            timestamp = datetime.datetime.now().isoformat()
